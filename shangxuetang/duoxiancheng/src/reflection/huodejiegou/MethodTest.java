...
public class MethodTest {
    ...
    public void test1() {
        ...
        for (Method method : methods) {
            /**
             * public int reflection.huodejiegou.Person.compareTo(java.lang.String)
             * public int reflection.huodejiegou.Person.compareTo(java.lang.Object)
             * public void reflection.huodejiegou.Person.info()
             * public java.lang.String reflection.huodejiegou.Person.display(java.lang.String)
             * public void reflection.huodejiegou.Creature.eat()
        ...
        for (Method declaredMethod : declaredMethods) {
             ...
             * public int reflection.huodejiegou.Person.compareTo(java.lang.Object)
             * public void reflection.huodejiegou.Person.info()
             * private java.lang.String reflection.huodejiegou.Person.show(java.lang.String)
             * public java.lang.String reflection.huodejiegou.Person.display(java.lang.String)
             */
        ...
        for (Constructor<?> constructor : constructors) {
            System.out.println(constructor);  //public reflection.huodejiegou.Person()
        }
        ...
        for (Constructor<?> constructor : declaredConstructor) {
            /**
             * reflection.huodejiegou.Person(java.lang.String,int)
             * private reflection.huodejiegou.Person(java.lang.String)
             * public reflection.huodejiegou.Person()
             */
    ...
    public void test2() {
        ...
        for (Method method : declaredMethods) {
            ...
            for (Annotation annotation : annotations) {
                System.out.println(annotation); //@reflection.huodejiegou.MyAnnotation(value=hello)
            }
            //2. 权限修饰符
