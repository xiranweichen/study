...
public class FieldTest {
    ...
    public void test1() {
        ...
        for (Field field : fields) {
            System.out.println(field);//public int reflection.huodejiegou.Person.id
                                      //public double reflection.huodejiegou.Creature.wight
        }
        ...
        for (Field declaredField : declaredFields) {
            System.out.println(declaredField); //private java.lang.String reflection.huodejiegou.Person.name
                                               //int reflection.huodejiegou.Person.age
                                               //public int reflection.huodejiegou.Person.id
        }
    }
