...
public class ReflectionTest {
    ...
    public void testForClass() throws ClassNotFoundException {
        ...
        System.out.println(personClass1);  //class reflection.Person

        //方式二：通过运行时类的对象,调用getClass()方法
        Person p1 = new Person();
        Class<? extends Person> p1Class = p1.getClass();
        System.out.println(p1Class);  //class reflection.Person

        //方式三：通过调用Class的静态方法
        Class<?> name = Class.forName("reflection.ReflectionTest");
        System.out.println(name);  //class reflection.ReflectionTest

        //方式四：使用类的加载器: ClassLoader
        ClassLoader classLoader = ReflectionTest.class.getClassLoader();
        Class<?> loadClass = classLoader.loadClass("reflection.ReflectionTest");
        System.out.println(loadClass);  //class reflection.ReflectionTest
