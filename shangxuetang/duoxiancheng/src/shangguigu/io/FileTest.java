...
public class FileTest {
    ...
    public void test2() {
        ...
        //获取绝对路径
        System.out.println(file1.getAbsolutePath()); //D:\work\work\shangxuetang\shangguigu.duoxiancheng\hello.txt
        //获取路径
        ...
        for (String s : fileList) {
            System.out.print(s + ","); //.idea,shangguigu.duoxiancheng,out,shangxuetang.iml,src,
        }
        System.out.println();
        ...
        for (File file : files) {
            System.out.print(file + ", ");  //D:\work\work\shangxuetang\.idea, D:\work\work\shangxuetang\shangguigu.duoxiancheng, D:\work\work\shangxuetang\out, D:\work\work\shangxuetang\shangxuetang.iml, D:\work\work\shangxuetang\src,
        }
        System.out.println();
    }
