package shangguigu.reflection.huodejiegou;
...
public class MethodTest {
    ...
    public void test1() {
        ...
        for (Method method : methods) {
            /**
             * public int shangguigu.reflection.huodejiegou.Person.compareTo(java.lang.String)
             * public int shangguigu.reflection.huodejiegou.Person.compareTo(java.lang.Object)
             * public void shangguigu.reflection.huodejiegou.Person.info()
             * public java.lang.String shangguigu.reflection.huodejiegou.Person.display(java.lang.String)
             * public void shangguigu.reflection.huodejiegou.Creature.eat()
        ...
        for (Method declaredMethod : declaredMethods) {
             ...
             * public int shangguigu.reflection.huodejiegou.Person.compareTo(java.lang.Object)
             * public void shangguigu.reflection.huodejiegou.Person.info()
             * private java.lang.String shangguigu.reflection.huodejiegou.Person.show(java.lang.String)
             * public java.lang.String shangguigu.reflection.huodejiegou.Person.display(java.lang.String)
             */
        ...
        for (Constructor<?> constructor : constructors) {
            System.out.println(constructor);  //public shangguigu.reflection.huodejiegou.Person()
        }
        ...
        for (Constructor<?> constructor : declaredConstructor) {
            /**
             * shangguigu.reflection.huodejiegou.Person(java.lang.String,int)
             * private shangguigu.reflection.huodejiegou.Person(java.lang.String)
             * public shangguigu.reflection.huodejiegou.Person()
             */
    ...
    public void test2() {
        ...
        for (Method method : declaredMethods) {
            ...
            for (Annotation annotation : annotations) {
                System.out.println(annotation); //@shangguigu.reflection.huodejiegou.MyAnnotation(value=hello)
            }
            //2. 权限修饰符
