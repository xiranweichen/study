...
public class FieldTest {
    ...
    public void test1() {
        ...
        for (Field field : fields) {
            System.out.println(field);//public int shangguigu.reflection.huodejiegou.Person.id
                                      //public double shangguigu.reflection.huodejiegou.Creature.wight
        }
        ...
        for (Field declaredField : declaredFields) {
            System.out.println(declaredField); //private java.lang.String shangguigu.reflection.huodejiegou.Person.name
                                               //int shangguigu.reflection.huodejiegou.Person.age
                                               //public int shangguigu.reflection.huodejiegou.Person.id
        }
    }
